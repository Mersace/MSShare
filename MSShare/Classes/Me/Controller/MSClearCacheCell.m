...
#define MSCustomCacheFile [NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask, YES).lastObject stringByAppendingPathComponent:@"Custom"]

@implementation MSClearCacheCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        dispatch_async(dispatch_get_global_queue(0, 0), ^{
            ...
            // 获得缓存文件夹路径
            unsigned long long size = MSCustomCacheFile.fileSize;
...
- (void)clearCache
{
    ...
    [[SDImageCache sharedImageCache] clearDiskOnCompletion:^{
        ...
        dispatch_async(dispatch_get_global_queue(0, 0), ^{
            ...
            [mgr removeItemAtPath:MSCustomCacheFile error:nil];
            [mgr createDirectoryAtPath:MSCustomCacheFile withIntermediateDirectories:YES attributes:nil error:nil];
